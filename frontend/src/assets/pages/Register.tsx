          ...
          {!selectedRole && (
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-200">
              ...
              <div className="flex flex-col gap-4">
                {[
                  { role: "DOCTOR", label: "Medical Doctor", desc: "For physicians and medical practitioners" },
                  { role: "PATIENT", label: "Patient", desc: "For patients seeking healthcare services" },
                  { role: "LABTECH", label: "Lab Technician", desc: "For laboratory professionals and staff" }
                ].map(({ role, label, desc }) => (
                  <button
                    key={role}
      ...
      <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-blue-600 to-blue-800 items-center justify-center p-12 relative">
        ...
        <div className="max-w-md text-white text-center relative z-10">
          <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
            <h2 className="text-3xl font-bold mb-6">Join Our Healthcare Network</h2>
            <p className="text-blue-100 mb-8 leading-relaxed">
              Connect with medical professionals and patients in a secure, streamlined platform designed for modern healthcare needs.
            </p>
            ...
            <div className="space-y-4 text-left">
              ...
              <div className="flex items-start">
                ...
                <span className="text-blue-100 text-sm">Real-time collaboration tools</span>
              </div>
              <div className="flex items-start">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-blue-200 mr-3 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                </svg>
                <span className="text-blue-100 text-sm">Secure messaging and file sharing</span>
              </div>
            </div>
          </div>
        </div>
